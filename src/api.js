 ...
 *
 * Осечку считаем «нет»: настоящий запрет живёт на бэкенде (вход в чужой класс
 * он отдаёт 403), а здесь признак решает только выбор экрана — и уронить из-за
 * него вход было бы хуже, чем показать лишний кабинет до следующего F5.
 */
