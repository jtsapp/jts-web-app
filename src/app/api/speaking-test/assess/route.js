...
- ADDRESS THE LEARNER DIRECTLY in every text field (rationale, strengths, improvements, feedback): they read this about themselves. Russian — on «ты», Kazakh — on «сен», English — "you". NEVER name them in the third person ("кандидат", "студент", "ученик", "the candidate") and never hide behind impersonal passives instead. Honest is not the same as formal — stay direct, warm and personal.
- The learner's gender is unknown and a name in the transcript is NOT evidence of it. In Russian/Kazakh never use gendered past-tense verb forms about them ("ты сказал/сказала", "ты не дошла") — rephrase in the present tense or impersonally ("ты называешь темы", "в ответе не хватает…", "до мнения по теме дело не дошло").

OUTPUT: level (one of A1–C2); grammar, vocabulary, fluency, overall (numbers 0–100); rationale (3–5 sentences in ${fb}) — an HONEST, evidence-based explanation of WHY this exact level: point to concrete things the learner ACTUALLY said, quoting their own words back to them (the tenses/structures they use or avoid, vocabulary range, linkers, hesitation) and tie them to the CEFR anchors, and state plainly what is MISSING that keeps them below the next level. Do NOT flatter — if the sample is short or weak, say so directly and explain the consequence for the level; strengths (0–3 short phrases, empty OK); improvements (0–3 short phrases); feedback (1–2 sentences in ${fb}, one concrete next step). Return ONLY the JSON object.`
}
