...
export const DICT = {
  ru: {
    ...
    'tutor.dexter.desc':
      'Молодой американский парень. Говорит живым уличным английским — сленг, «yo», «chill bro», «no cap». Никакого учительского тона: подкалывает, поддерживает и исправляет ошибки прямо по ходу разговора. Общается и объясняет на русском, а английский даёт живыми примерами.',
  ...
  kz: {
    ...
    'tutor.dexter.desc':
      'Жас америкалық жігіт. Тірі көше ағылшынымен сөйлейді — сленг, «yo», «chill bro», «no cap». Ұстаздық үн жоқ: қалжыңдайды, қолдайды және қателерді әңгіме үстінде түзеп отырады. Орысша сөйлесіп, орысша түсіндіреді, ағылшынды тірі мысалдармен береді.',
  ...
  en: {
    ...
    'tutor.dexter.desc':
      'A young American guy. Talks in real street English — slang, "yo", "chill bro", "no cap". Zero teacher voice: he jokes around, hypes you up and fixes your mistakes right inside the conversation. Talks and explains in Russian, and gives English through live examples.',
