...
export const DICT = {
  ru: {
    ...
    'tutor.dexter.desc':
      'Тёплый и любопытный гик-друг. Обожает учиться и делиться знаниями, но без занудства. Не строгий учитель, а заряжающий энтузиазмом товарищ, который превращает учёбу в приключение. Общается и объясняет на русском, а английский даёт примерами.',
  ...
  kz: {
    ...
    'tutor.dexter.desc':
      'Жылы әрі қызығушыл гик-дос. Оқуды және білім бөлісуді жақсы көреді, бірақ жалықтырмайды. Қатал ұстаз емес, оқуды шытырман оқиғаға айналдыратын жігерлі жолдас. Орысша сөйлесіп, орысша түсіндіреді, ағылшынды мысалдармен береді.',
  ...
  en: {
    ...
    'tutor.dexter.desc':
      'A warm and curious geek friend. Loves learning and sharing knowledge, but without being dull. Not a strict teacher, but an enthusiastic buddy who turns study into an adventure. Talks and explains in Russian, and gives English through examples.',
