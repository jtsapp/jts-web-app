// Разбор результата теста на определение уровня (public/practice/placement/).
// Раннер школы присылает наружу весь объект S.result() — с θ, SE, флагами,
// профилем по навыкам и баллами блоков. Приложению из него нужен уровень, и
// брать его надо аккуратно: это единственное поле, которое уезжает в профиль
// студента и определяет весь его дальнейший контент.

export const PLACEMENT_URL = '/practice/placement/index.html'
