 ...
 *
 * Раньше был `resume` + TTL на брошенный прогон: mergeGradedAnswers отдаёт на
 * повтор СТАРЫЙ вердикт, и случайные клики по разминке «залипали» (тест всегда
 * A0). Restart с чистым журналом закрывает тот же баг без TTL.
