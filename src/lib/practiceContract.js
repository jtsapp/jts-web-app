...
// 'workbook' — прогресс по экранам воркбука {prog, miss, sc}. Отдельный модуль
// рядом с 'workbooks': тот остаётся множеством открытых уровней, потому что на
// нём считается квота PRACTICE_WORKBOOKS, а этот хранит само прохождение.
