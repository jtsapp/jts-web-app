...
export const TUTOR_GREETING = {
  ...
  // Джарвис говорит по-казахски и по-английски, как Спарк (секция LANGUAGE в
  // data/persona-jarvis.md); русского у него больше нет. Обращение «мырза» на
  // «сіз» — его опознавательный знак, поэтому оно стоит уже в первой фразе.
  jarvis: 'Сәлеметсіз бе, мырза. Бүгін немен айналысамыз?',
