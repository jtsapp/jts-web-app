...
export const EMOTIONS = {
  ...
  // Брови несут злость: без них прищур + хмурый рот = тот же correcting,
  // только красный. Дрожь отделяет её от «строго смотрю».
  angry: {
    label: 'Злится',
    c1: [255, 138, 128],
    c2: [214, 45, 60],
    eyeH: 0.62, eyeW: 1.1, lookY: 0.05, curve: -0.55, bounce: 0.55, speed: 1.6,
    brow: -1, shake: 1, mouth: 'line', steam: 1,
  },
