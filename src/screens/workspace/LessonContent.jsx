...
export default function LessonContent({ step, answers, checkedKeys, onAnswer, onCheck, readOnly, lockNote = '', liveQuestionId, liveFocusNonce, token, source, catalogLessonId, hiddenBlocks, hideStepTitle, revealedCards, showAnswerKey = true }) {
