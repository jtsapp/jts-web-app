...
// Статусы занятия, при которых сеанс ещё жив. Любой другой статус, включая
// COMPLETED, — сеанс кончился.
//
// Здесь список НЕ такой, как в расписании ученика: обычный урок с 20.09.2026
// открыт всегда (spec-lesson-always-open), а класс преподавателя — киоск для
// гостя с пробного. Пустить его в незапущенное или уже закрытое занятие
// нельзя: бэкенд считает вход в закрытый сеанс новым занятием и заводит его с
// пустой доской, потеряв наработанное.
