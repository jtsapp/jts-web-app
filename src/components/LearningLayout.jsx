...
export default function LearningLayout({
  ...
  // и язык: заголовки экранов на телефоне из макета убраны (.pk-head__title,
  // .lp-isle__title в media 760), и рядом с ними «?» просто исчезала бы.
  // На десктопе «Практики» угла нет вовсе — там по макету переключатель
  // уровня (см. .learn__main:has(.pk) в styles.css).
  onHelp,
  children,
}) {
  const { t } = useI18n()
