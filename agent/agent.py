...
MOOD_HINTS: dict[str, str] = {
    ...
    "correcting": "мягко поправляешь ошибку",
    ...
    "anger": "злость по характеру персонажа",
    "disgust": "брезгливость, «фу»",
    "gloat": "злорадство, «я же говорил»",
}
...
def build_mood_block(tutor: str) -> str:
    ...
    return (
        "\n==== MOOD TAG (silent) ====\n"
        "Начинай реплику с тега [mood:<имя>:<сила>]; сила — 1 (слабо), "
        "2 (заметно) или 3 (сильно). Имя — одно из:\n"
        f"{lines}\n"
