...
На экранах ≤820px сайдбар (`.sb`) скрыт; навигация — нижний хотбар
(`src/components/HotBar.jsx`, рендерится один раз в App.jsx): Уроки (план
уроков тьютора), Сценарии, Тьютор (дашборд), Управление, Профиль. Хотбар
скрыт в auth-цепочке и полноэкранном голосовом чате (`HOTBAR_HIDDEN` в
App.jsx). Новым «app-зонным» экранам добавляй нижний отступ под хотбар
(см. медиаблоки в styles.css / tutor.css).
